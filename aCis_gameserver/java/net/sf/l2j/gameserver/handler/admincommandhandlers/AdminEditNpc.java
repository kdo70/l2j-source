		...
		if (!npcData.getDropData().isEmpty())
		{
			...
			for (DropCategory cat : npcData.getDropData())
			{
				...
				for (DropData drop : cat.getAllDrops())
				{
					...
					StringUtil.append(sb, "<tr><td><font color=\"", ((cat.isSweep()) ? "00FF00" : "3BB9FF"), "\">", cat.getCategoryType(), "</td><td>", ItemData.getInstance().getTemplate(drop.getItemId()).getName(), " (", drop.getItemId(), ")</td></tr>");
					shown++;
				}
			}
